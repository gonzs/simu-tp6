def imprimir_resultados(total_arribos, reservas_rechazadas, bonificaciones, total_huespedes, 
                    habitaciones_simples, habitaciones_dobles, habitaciones_suites, 
                    calcular_pto, tiempo_simulacion, guardar_csv=True,
                    rechazos_simple=0, rechazos_doble=0, rechazos_suite=0,
                    camas_simples=None, cunas=None):
    """Imprimir resultados de la simulación y opcionalmente guardarlos en un archivo CSV"""
